		...
		<?php if ( ! empty( $filters ) ) : ?>
			<div id="tribe-bar-filters-wrap">
				...
				<button
					...
					data-label-hidden="<?php printf( esc_html__( 'Показать поиск по мероприятиям', 'the-events-calendar' ), tribe_get_event_label_plural() ); ?>"
					data-label-shown="<?php printf( esc_html__( 'Скрыть поиск по мероприятиям', 'the-events-calendar' ), tribe_get_event_label_plural() ); ?>"
				>
