<?php
/*
Template name: Services in page
*/
...
?>
    ...
    <section>
        ...
        <?php if(!empty(get_post_meta( get_the_ID(), 'additional_description_services_in_page', $single = true ))){ ?>
        <div class="row">
           <div class="col-md-12">
                <div class="services-seotext">
                   <?php echo wpautop(get_post_meta( get_the_ID(), 'additional_description_services_in_page', $single = true )); ?>
                </div>
           </div>
        </div>
        <?php } ?>
